#     **CSc 59867: Senior Project II** ***AI Agents for Decision Making in the Real World***

**Time:** Fall 2026, Mon/Wed 2:00p-3:15p		**Room:** SH-205  
...
Artificial Intelligence (AI) Agents are autonomous systems that can take reasonable actions, be it in the virtual or the real world. The class objective of Senior Project II is to scale up from simulation and prototype phase of research and development in Senior Project I to design and implement at a significant scale Agentic Machine Learning Algorithms in Senior Project II that allow AI to observe their environment, take an action that impacts the environment, and find qualitative and quantitative approaches (including receiving environmental feedback) to evaluate the goodness of the AI's decision making. 

Students will be training and building Physical and Virtual Multimodal AI Agents (e.g., Large Language Models or LLM Agents, Audio-Vision-Language Models or AVLM Agents, Robotic Agents, Scientific Discovery Agents, Design and Synthesis Agents, Autonomous Transportation Agents, AR/VR/XR Agents, Scientific Discovery Agents, Energy Orchestrator Agents, Autonomous Vehicle Agents, Financial Trading/Supply Chain Agents, Agents that orchestrate Hardware Architectures/Systems/Networks and other Multimodal AI Agents) in this research project-oriented course. 

The Senior Project II course will strengthen the research and development of AI Agents building on the fundamental introductions from Senior Project I about training, finetuning, and inferencing of AI Agents on existing training datasets and environments. Students will learn how to expand these fundamental concepts in the active learning exploration, continual learning, and have prototype AI Agents, models, environments and datasets published in a report with open-source accessibility, having appropriate licensing. Students will not just implement systems but will also explore algorithms and theory behind those systems to address fundamental questions like how can we make the AI Agents data efficient/energy efficient/robust/generalizable among other interdisciplinary questions for Research and Development. Students will build on their learning to decide when to do single-agent vs multi-agent learning or when to do multi-processing/distributed processing and when not to do it. The class will introduce to students real-world problems which can be often solved simply with counterfactual design, parametric harmonization, autonomous exploration algorithms, methods which students will explore. This involves an insight of how AI Agents balance their autonomous decision making capabilities with system parameters like latency, energy utilization, water and cooling, network bandwidth utilization, chip utilization, real-time execution, standardization, reliability and effective job prioritization with queuing among other computing parameters. 

If a team chooses a Scientific Discovery project (e.g., utilizing massive databases like the Protein Data Bank or UniProt), it is required that at least one team member requests and utilizes the Empire AI cluster due to the massive compute and storage requirements.
...
The second semester (Fall 2026\) will focus on implementation and scale up the basics of training, finetuning, and inferencing of AI Agents.
...
**Project Deliverables:** Students are expected to develop an open-source code base, a preliminary prototype Demo at the end of CSc 59867-E, and write a research report on their findings. 
...
- If students must miss class for job interviews or higher education events, they can notify the professor in advance to have their participation grade for that day waived.

**Alternate Class Formats:** If the professor is away for essential conferences or grant obligations, he will provide recorded lectures, host a Zoom classroom, or schedule an alternate class day so instruction is not affected.
...
1. Students whose research projects require high-performance computing will be granted access to the state's Empire AI cluster (featuring state-of-the-art B200 GPUs). To request access, students must provide me with their phone number, personal Gmail, and CUNY email address. This information will be forwarded to the CUNY HPCC director, who will send an SMS text for verification; students must validate this text within 24 hours.
...
**Tentative Course Schedule (Fall 2026\)**
...
| :---- | :---- | :---- |
| **Aug 31** | Introduction: Implementing AI Agents in the Real and Virtual World |  |
| **Sep 2** | Scientific Discovery and Autonomous Task Exploration |  |
...
| **Oct 7** | Advanced Topics: Real-World Supply Chain Logistics and Orchestration |  |
| **Oct 13** *(Follows Monday Schedule)* | Advanced Topics: Drone Swarms, Autonomous Vehicles, and Transportation  Advanced Topics: Augmented Reality (AR/VR/XR) and Hardware Agents |  |
| **Oct 14** | **New Developments:** Quantum Control Mechanisms and Non-Deterministic AI |  |
| **Oct 19** | Navigating Open-Ended Problems, Establishing New Metrics, and Reliability | **Bi-Weekly** Research Project Update 1 Due on **Oct 19** |
| **Oct 21** | MidTerm Exam Project Presentations (Part I) | MidTerm Exam Project Presentation (with 1-page report) Due |
| **Oct 26** | MidTerm Exam Project Presentations (Part II) |  |
| **Oct 28** | Scaling Up: Distributed Processing and B200 GPU Utilization on Empire AI |  |
| **Nov 2** | Guest Lecture: Perspectives from Industry and Big Tech | **Bi-Weekly** Research Project Update 2 Due on **Nov 2** |
| **Nov 4** | Guest Lecture: Perspectives from Academia, National Labs, and Defense |  |
| **Nov 9** | Troubleshooting Implementations: Overcoming the "Moravec's Paradox" in Robotics |  |
| **Nov 11** | Trust and Alignment: Preventing Reward Hacking and Pathological Agent Optimizations | Hand-Written Research Paper Review 2 Due on **Nov 11** |
| **Nov 16** | Open-Source Licensing, Hugging Face Integration, and Deployment Strategies | **Bi-Weekly** Research Project Update 3 Due on **Nov 16** |
| **Nov 18** | Future Horizons: Interstellar Internet and Advanced Sensing Networks |  |
| **Nov 23** | Hands-On Coding Lab / Project Troubleshooting |  |
| **Nov 25** | No Classes Scheduled (**Thanksgiving Recess**) |  |
| **Nov 30** | Finalizing 8-Page Research Reports and LaTeX Formatting | **Bi-Weekly** Research Project Update 4 Due on **Nov 30** |
| **Dec 2** | Course Wrap-up: Preparing for Job Interviews, Graduate School, and Academic Milestones |  |
| **Dec 7** | Final Project Troubleshooting and Presentation Prep |  |
| **Dec 9** | Final Exam Class Research Project Presentations (Part I) | **Bi-Weekly** Research Project Update 5 Due on **Dec 9** |
| **Dec 14** | Final Exam Class Research Project Presentations (Part II) | Final Presentations and Code Due. Attendance is mandatory for all students. |
| **Dec 15–21** | Final Exam Week Class Research Project Report | Final Project Report (8-pages) and Final Code Due on Final Exam Week (Specific Date TBA) |
...
* Classwork Assignments (20%)  
  * Classwork will consist of programming tasks and theoretical pen and paper exams will be graded during a break in class.  
...
* Classroom Participation (12%)  
  * Classroom Questions In-Person (1% in each class during interactions, maximum of 12 classes)  
* Group Project (53%)  
  * 1 page project abstract (5%)  
  * MidTerm Exam Project Presentation (7%)  
    * A simple one-page report must accompany the midterm presentation  
  * Final Exam Project Presentation (10%)  
  * Final Exam Project Report (31%)  
  ...
  * Provide the open-source code links in your reports with appropriate licensing

NOTE: The grading is designed to encourage student learning and participation and address challenges from Generative AI with in-class learning, regular updates, classroom participation and project presentation.
...
* Long-term: NeurIPS, IROS, NAACL, CoRL,  and other conferences and journals
...
2. You are allowed to use Generative AI during class homework and projects (NOT IN EXAMS) subject to:  
   ...
   4. Rewrite RELEVANT PARTS of Generative AI outputs in your own words\! Every written letter in your submissions must be your own.  
   5. AI Detectors: I will not use AI detectors to evaluate student work. AI detectors are unreliable and create an incentive for students to use additional tools to humanify their text. Instead, I will use other methods to ensure students thoroughly understand their work.  
